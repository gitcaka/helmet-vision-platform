    ...
    <v-col class="d-flex align-center justify-center">
      <div class="text-center">
        <div class="CardMediaWrapper">
          <img src="@/assets/img-error-bg.svg" alt="grid" class="w-100" />
          <img src="@/assets/img-error-blue.svg" alt="grid" class="CardMediaParts" />
          <img src="@/assets/img-error-text.svg" alt="build" class="CardMediaBuild" />
          <img src="@/assets/img-error-purple.svg" alt="build" class="CardMediaBuild" />
        </div>
